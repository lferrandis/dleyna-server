...
{"upnp:class",			DLS_INTERFACE_PROP_TYPE,			DLS_UPNP_MASK_PROP_TYPE,			FALSE,	TRUE,	FALSE}, /* Type */
{"upnp:class",			DLS_INTERFACE_PROP_TYPE_EX,			DLS_UPNP_MASK_PROP_TYPE_EX,			FALSE,	TRUE,	TRUE},  /* Type_Ex */
